...
Notas
- Para desenvolvimento MSW é carregado automaticamente em `development`.
- Deploy: empurre para um repositório e importe no Vercel (Next.js é detectado automaticamente).
